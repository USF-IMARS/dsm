...
java -cp $DSM_HOME/lib/test.jar:$DSM_HOME/lib/dsm.jar:$DSM_HOME/lib/agent.jar:$DSM_HOME/lib/mysql-jdbc.jar:$DSM_HOME/lib/ftp.jar:$NISGS_HOME/nsls/lib/nsls.jar:$NISGS_HOME/properties/lib/properties.jar -DMODULE_HOME=$DSM_HOME gov.nasa.gsfc.nisgs.dsm.test.TestDFR $1
