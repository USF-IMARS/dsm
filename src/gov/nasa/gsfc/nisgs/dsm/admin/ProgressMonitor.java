...
public class ProgressMonitor extends Object implements Accessible
{
    ...
    // DRL - support for setPreferredSize
    private Dimension       preferredSize = null;
    public void setPreferredSize(Dimension d) { preferredSize = d; }
    public Dimension getPreferredSize() { return preferredSize; }

    // DRL - function to paper over lack of JOptionPane.getWindowForComponent
    ...
    public ProgressMonitor(Component parentComponent,
                           ...
                           int min,
                           int max) {
        this(parentComponent, message, note, min, max, null, true);
    }
    ...
    public ProgressMonitor(Component parentComponent,
                           ...
                           int max,
			   boolean allowCancel) {
        this(parentComponent, message, note, min, max, null, allowCancel);
    }
	...
	else cancelOption = new Object[0];
	...
	// DRL - our ProgressMonitor will be modal by default
	    ...
	    // DRL - do not know what this does,
	    // but SwingUtilities.SharedOwnerFrame
	    // is private, so this currently can't work
	    /*
    ...
    public void setProgress(int nv) {
        if (nv >= max) {
			...
			// dialog.show() deprecated at Java 1.5(!)
                        //dialog.show();
